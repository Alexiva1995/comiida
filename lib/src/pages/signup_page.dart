         ...
         children: <Widget>[
           ...
           Column(
             ...
             children: <Widget>[
              ...
              _buttonFill(context ,"Sign up using phone" ,  3),
             ],
            ),
           ...
           Column(
              crossAxisAlignment: CrossAxisAlignment.center,
             children: <Widget>[
                Text("Already have an account?" , style: TextStyle(color: Colors.grey[400] ,  fontSize: 17 , fontWeight: FontWeight.bold),),
                SizedBox(height: 4,),
                Text("Login here" , style: TextStyle(color: Color.fromRGBO(237, 29, 29 , 0.5) ,  fontSize: 17 , fontWeight: FontWeight.bold),),
             ],
            ),
...
_buttonFill(BuildContext context,  String title , int opt) {
    int optselected = opt;
